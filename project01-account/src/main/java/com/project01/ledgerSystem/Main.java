package com.project01.ledgerSystem;

import com.project01.ledgerSystem.models.User;
import com.project01.ledgerSystem.service.UserServiceImpl;
...
public class Main {
    ...
    public static boolean mainUI(User user) {
        try {
            while (true) {
                ...
                switch (fucNum) {
                    ...
                    case 3:
                        ...
                        if (withdrawMoney <= user.getUserBalance() && withdrawMoney > 0) {
                            if (userSer.withdrawMoney(user, withdrawMoney) != -1) {
    ...
    public static User logInUI() {
        ...
        while (!isSuccess) {
            ...
            if (name.equals("0")) {
                ...
                User user = userSer.logIn(name, password);
                if (user != null) {
    ...
    public static User SignInUI() {
        ...
        if (input.next().equalsIgnoreCase("y")) {
            ...
            System.out.print("请输入密码：");
            String password = input.next();
            if (userSer.signIn(name, password)) {
